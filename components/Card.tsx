...
const Card: React.FC<CardProps> = ({ title, description, imageUrl, price }) => {
  return (
      <Link href={'/'}>
            <div className="group relative w-full rounded-lg bg-white p-5 border border-transparent hover:border-gray-200 hover:shadow-lg hover:scale-[1.01] transition-all duration-500">
                  {/* Image Section */}
                  ...
                  <div className="mt-2">
                        ...
                        <div className="flex items-center justify-end">
                              <button className="mt-3 border border-black rounded py-4 px-5 hover:bg-black hover:text-white transition-all duration-300">
