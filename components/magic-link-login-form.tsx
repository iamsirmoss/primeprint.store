...
export const MagicLinkLoginForm = ({
  ...
  return (
    <details ref={ref} className="w-full rounded-2xl border overflow-hidden">
      <summary className="flex gap-2 items-center justify-center px-2 py-3.5 bg-black text-white hover:bg-black/80 transition duration-300 cursor-pointer text-sm font-medium">
        Continue with email link
      </summary>
