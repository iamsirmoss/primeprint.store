...
const Banner3 = () => {
  return (
    <div className=''>
            <div className='bg-gray-500 w-full block md:flex items-center justify-between'>
                  ...
                  '>
                        ...
                        <div className='w-fit'>
                              <Link href={'/learn-more'} className=''>
                                    <button className='bg-red-500 text-white rounded-2xl px-10 py-4 shadow-[rgba(13,38,76,0.19)_0px_9px_20px] hover:bg-blue-400 
