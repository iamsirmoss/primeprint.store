...
import AnimatedItem from "@/components/animatedComponents/ListAnimation";
import InputPlaceholderAnimate from "@/components/animatedComponents/AnimatedInputPlaceholder";
  ...
  return (
    <Dialog open={openModal} onOpenChange={setOpenModal}>
      <DialogTrigger asChild>
        <button className="px-[15px] hover:text-primary text-darklink dark:text-white dark:hover:text-primary relative after:absolute after:w-10 after:h-10 after:rounded-full hover:after:bg-lightprimary  after:bg-transparent rounded-full flex justify-center items-center cursor-pointer">
          <Icon icon="solar:magnifer-line-duotone" height={20} width={20} />
        </button>
      </DialogTrigger>
      <DialogContent className="w-full max-w-2xl p-0 gap-0 [&>button]:hidden">
        <div className=" p-6 border-b border-ld">
          <InputPlaceholderAnimate
            ...
            className="flex-1 pl-4 rounded-md"
          />
        </div>
