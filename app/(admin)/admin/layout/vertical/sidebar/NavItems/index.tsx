  ...
  return (
    <>
      ...
      <Link href={item.url} onClick={handleClick}>
        <SidebarMenuItem
          className={`
    hover:transform hover:translate-x-1 transition-all duration-200 ease-in-out p-2.5 mb-1 rounded-md
    ${item.disabled
              ...
              : item.url === pathname
                ? isInsideCollapse
                  ...
                  } bg-primary shadow-btnshdw hover:bg-primary dark:hover:bg-primary hover:text-white`
                : isInsideCollapse
              ...
              {item.icon ? (
                ...
                <span
                  className={`${item.url == pathname
                      ...
                      : 'size-2 bg-transparent! border border-dark dark:border-white/70 rounded-full mx-1 group-hover/link:border-primary! group-hover/icon:border-primary dark:group-hover/icon:border-primary'
                    } `}></span>
              )}
              <div
