          ...
          <form ref={formRef} action={formAction}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="relative">
                <User className="absolute top-1.5 size-5 md:size-6 text-gray-400" />
                <input
                  type="text"
                  name="name"
                  className="peer w-full bg-transparent pl-9 py-2 focus:outline-none text-base placeholder-gray-400"
                  placeholder="Name"
                />
              ...
              {/* Email */}
              <div className="relative">
                <Mail className="absolute top-1.5 size-5 md:size-6 text-gray-400" />
                <input
                  type="email"
                  name="email"
                  className="peer w-full bg-transparent pl-9 py-2 focus:outline-none text-base placeholder-gray-400"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
              {/* Phone */}
              <div className="relative">
                <Phone className="absolute top-1.5 size-5 md:size-6 text-gray-400" />
                <input
                  type="text"
                  name="phoneNumber"
                  className="peer w-full bg-transparent pl-9 py-2 focus:outline-none text-base placeholder-gray-400"
              ...
              {/* Subject */}
              <div className="relative">
                <CircleAlert className="absolute top-1.5 size-5 md:size-6 text-gray-400" />
                <input
                  type="text"
                  name="service"
                  className="peer w-full bg-transparent pl-9 py-2 focus:outline-none text-base placeholder-gray-400"
            ...
            <div className="mt-10 relative">
              <Building2 className="absolute top-1.5 size-5 md:size-6 text-gray-400" />
              <input
                type="text"
                name="company"
                className="peer w-full bg-transparent pl-9 py-2 focus:outline-none text-base placeholder-gray-400"
            ...
            {/* Message */}
            <div className="mt-10 relative">
              <PencilRuler className="absolute top-1.5 size-5 md:size-6 text-gray-400" />
              <textarea
                name="description"
                rows={4}
                className="peer w-full bg-transparent pl-9 py-2 focus:outline-none text-base placeholder-gray-400"
